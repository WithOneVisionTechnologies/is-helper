...
describe("isNull", () => {
  ...
  describe("false test cases", () => {
    ...
    it("should return false for a Date object created with a string", () => {
      expect(IsHelper.isNull(new Date("2021-01-01T00:00:00.000Z"))).toBe(
        false,
      );
    });
    ...
    it("should return false for a Float16Array", () => {
      expect(IsHelper.isNull(new Float16Array())).toBe(false);
    });
...
describe("isUndefined", () => {
  ...
  describe("false test cases", () => {
    ...
    it("should return false for a Date object created with a string", () => {
      expect(IsHelper.isUndefined(new Date("2021-01-01T00:00:00.000Z"))).toBe(
        false,
      );
    });
    ...
    it("should return false for a Float16Array", () => {
      expect(IsHelper.isUndefined(new Float16Array())).toBe(false);
    });
...
describe("isNullOrUndefined", () => {
  ...
  describe("false test cases", () => {
    ...
    it("should return false for a Date object created with a string", () => {
      expect(IsHelper.isNullOrUndefined(new Date("2021-01-01T00:00:00.000Z")))
        .toBe(
          false,
        );
    });
    ...
    it("should return false for a Float16Array", () => {
      expect(IsHelper.isNullOrUndefined(new Float16Array())).toBe(false);
    });
...
describe("isNullOrUndefinedOrEmptyStringOrWhitespace", () => {
  describe("true test cases", () => {
    it("should return true for an empty string", () => {
      expect(IsHelper.isNullOrUndefinedOrEmptyStringOrWhitespace("")).toBe(
        true,
      );
    });
    ...
    it("should return true for a null", () => {
      expect(IsHelper.isNullOrUndefinedOrEmptyStringOrWhitespace(null)).toBe(
        true,
      );
    });

    it("should return true for an undefined", () => {
      expect(IsHelper.isNullOrUndefinedOrEmptyStringOrWhitespace(undefined))
        .toBe(true);
    });
  });
  ...
  describe("false test cases", () => {
    it("should return false for a string with a value", () => {
      expect(IsHelper.isNullOrUndefinedOrEmptyStringOrWhitespace("a")).toBe(
        false,
      );
    });
    ...
    it("should return false for a string with whitespace in the middle", () => {
      expect(IsHelper.isNullOrUndefinedOrEmptyStringOrWhitespace("a b")).toBe(
        false,
      );
    });
    ...
    it("should return false for boolean true", () => {
      expect(IsHelper.isNullOrUndefinedOrEmptyStringOrWhitespace(true)).toBe(
        false,
      );
    });

    it("should return false for boolean false", () => {
      expect(IsHelper.isNullOrUndefinedOrEmptyStringOrWhitespace(false)).toBe(
        false,
      );
    });

    it("should return false for a number", () => {
      expect(IsHelper.isNullOrUndefinedOrEmptyStringOrWhitespace(1)).toBe(
        false,
      );
    });
    ...
    it("should return false for an object", () => {
      expect(IsHelper.isNullOrUndefinedOrEmptyStringOrWhitespace({ a: 1 }))
        .toBe(false);
    });
    ...
    it("should return false for a Map", () => {
      expect(IsHelper.isNullOrUndefinedOrEmptyStringOrWhitespace(new Map()))
        .toBe(false);
    });

    it("should return false for a Set", () => {
      expect(IsHelper.isNullOrUndefinedOrEmptyStringOrWhitespace(new Set()))
        .toBe(false);
    });

    it("should return false for a Date", () => {
      expect(IsHelper.isNullOrUndefinedOrEmptyStringOrWhitespace(new Date()))
        .toBe(false);
    });
    ...
    it("should return false for a Symbol", () => {
      expect(IsHelper.isNullOrUndefinedOrEmptyStringOrWhitespace(Symbol()))
        .toBe(false);
    });

    it("should return false for an Error", () => {
      expect(IsHelper.isNullOrUndefinedOrEmptyStringOrWhitespace(new Error()))
        .toBe(false);
    });

    it("should return false for a Promise", () => {
      expect(
        IsHelper.isNullOrUndefinedOrEmptyStringOrWhitespace(Promise.resolve()),
      ).toBe(false);
    });
    ...
    it("should return false for a Uint8Array", () => {
      expect(
        IsHelper.isNullOrUndefinedOrEmptyStringOrWhitespace(new Uint8Array()),
      ).toBe(false);
    });

    it("should return false for a Uint16Array", () => {
      expect(
        IsHelper.isNullOrUndefinedOrEmptyStringOrWhitespace(new Uint16Array()),
      ).toBe(false);
    });

    it("should return false for a Uint32Array", () => {
      expect(
        IsHelper.isNullOrUndefinedOrEmptyStringOrWhitespace(new Uint32Array()),
      ).toBe(false);
    });

    it("should return false for a Int8Array", () => {
      expect(
        IsHelper.isNullOrUndefinedOrEmptyStringOrWhitespace(new Int8Array()),
      ).toBe(false);
    });

    it("should return false for a Int16Array", () => {
      expect(
        IsHelper.isNullOrUndefinedOrEmptyStringOrWhitespace(new Int16Array()),
      ).toBe(false);
    });

    it("should return false for a Int32Array", () => {
      expect(
        IsHelper.isNullOrUndefinedOrEmptyStringOrWhitespace(new Int32Array()),
      ).toBe(false);
    });

    it("should return false for a Float16Array", () => {
      expect(
        IsHelper.isNullOrUndefinedOrEmptyStringOrWhitespace(new Float16Array()),
      ).toBe(
        false,
      );
    });
    ...
    it("should return false for a Float32Array", () => {
      expect(
        IsHelper.isNullOrUndefinedOrEmptyStringOrWhitespace(new Float32Array()),
      ).toBe(
        false,
      );
    });
    ...
    it("should return false for a Float64Array", () => {
      expect(
        IsHelper.isNullOrUndefinedOrEmptyStringOrWhitespace(new Float64Array()),
      ).toBe(
        false,
      );
    });
    ...
    it("should return false for a WeakMap", () => {
      expect(IsHelper.isNullOrUndefinedOrEmptyStringOrWhitespace(new WeakMap()))
        .toBe(false);
    });

    it("should return false for a WeakSet", () => {
      expect(IsHelper.isNullOrUndefinedOrEmptyStringOrWhitespace(new WeakSet()))
        .toBe(false);
    });

    it("should return false for a BigInt", () => {
      expect(IsHelper.isNullOrUndefinedOrEmptyStringOrWhitespace(BigInt(1)))
        .toBe(false);
    });
