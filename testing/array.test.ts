...
describe("isArray", () => {
  describe("true test cases", () => {
    ...
    it("should return true for a Float16Array", () => {
      expect(IsHelper.isArray(new Float16Array())).toBe(true);
    });
...
describe("isEmptyArray", () => {
  describe("true test cases", () => {
    ...
    it("should return true for a Float16Array", () => {
      expect(IsHelper.isEmptyArray(new Float16Array())).toBe(true);
    });
  ...
  describe("false test cases", () => {
    ...
    it("should return false for a DataView", () => {
      expect(IsHelper.isEmptyArray(new DataView(new ArrayBuffer(8)))).toBe(
        false,
      );
    });
  });
...
describe("isNonEmptyArray", () => {
  describe("true test cases", () => {
    ...
    it("should return true for a Float16Array", () => {
      expect(IsHelper.isNonEmptyArray(new Float16Array([1, 2, 3]))).toBe(true);
    });
    ...
    it("should return true for a Uint8ClampedArray", () => {
      expect(IsHelper.isNonEmptyArray(new Uint8ClampedArray([1, 2, 3]))).toBe(
        true,
      );
    });

    it("should return true for a BigInt64Array", () => {
      expect(IsHelper.isNonEmptyArray(new BigInt64Array([1n, 2n, 3n]))).toBe(
        true,
      );
    });

    it("should return true for a BigUint64Array", () => {
      expect(IsHelper.isNonEmptyArray(new BigUint64Array([1n, 2n, 3n]))).toBe(
        true,
      );
    });
  });
  ...
  describe("false test cases", () => {
    ...
    it("should return false for a Float16Array", () => {
      expect(IsHelper.isNonEmptyArray(new Float16Array())).toBe(false);
    });
    ...
    it("should return false for a DataView", () => {
      expect(IsHelper.isNonEmptyArray(new DataView(new ArrayBuffer(8)))).toBe(
        false,
      );
    });
  });
