...
describe("isString", () => {
  ...
  describe("false test cases", () => {
    ...
    it("should return false for a Float16Array", () => {
      expect(IsHelper.isString(new Float16Array())).toBe(
        false,
      );
    });

    it("should return false for a Float32Array", () => {
      expect(IsHelper.isString(new Float32Array())).toBe(
        false,
      );
    });

    it("should return false for a Float64Array", () => {
      expect(IsHelper.isString(new Float64Array())).toBe(
        false,
      );
    });
...
describe("isEmptyString", () => {
  ...
  describe("false test cases", () => {
    ...
    it("should return false for a Float16Array", () => {
      expect(IsHelper.isEmptyString(new Float16Array())).toBe(false);
    });
...
describe("isWhiteSpaceString", () => {
  ...
  describe("false test cases", () => {
    ...
    it("should return false for a Float16Array", () => {
      expect(IsHelper.isWhiteSpaceString(new Float16Array())).toBe(false);
    });
...
describe("isEmptyStringOrWhitespace", () => {
  ...
  describe("false test cases", () => {
    ...
    it("should return false for a Float16Array", () => {
      expect(IsHelper.isEmptyStringOrWhitespace(new Float16Array())).toBe(
        false,
      );
    });

    it("should return false for a Float32Array", () => {
      expect(IsHelper.isEmptyStringOrWhitespace(new Float32Array())).toBe(
        false,
      );
    });

    it("should return false for a Float64Array", () => {
      expect(IsHelper.isEmptyStringOrWhitespace(new Float64Array())).toBe(
        false,
      );
    });
...
describe("isIpv4", () => {
  ...
  describe("false test cases", () => {
    ...
    it("should return false for a Float16Array", () => {
      expect(IsHelper.isIpv4(new Float16Array())).toBe(
        false,
      );
    });

    it("should return false for a Float32Array", () => {
      expect(IsHelper.isIpv4(new Float32Array())).toBe(
        false,
      );
    });

    it("should return false for a Float64Array", () => {
      expect(IsHelper.isIpv4(new Float64Array())).toBe(
        false,
      );
    });
