...
describe("isEmptyObject", () => {
  ...
  describe("false test cases", () => {
    ...
    it("should return false for a Date object created with a string", () => {
      expect(IsHelper.isEmptyObject(new Date("2021-01-01T00:00:00.000Z"))).toBe(
        false,
      );
    });
    ...
    it("should return false for a Float16Array", () => {
      expect(IsHelper.isEmptyObject(new Float16Array())).toBe(false);
    });
    ...
    it("should return false for a DataView", () => {
      expect(IsHelper.isEmptyObject(new DataView(new ArrayBuffer(8)))).toBe(
        false,
      );
    });
  });
...
describe("isPlainObject", () => {
  ...
  describe("false test cases", () => {
    ...
    it("should return false for a Date object created with a string", () => {
      expect(IsHelper.isPlainObject(new Date("2021-01-01T00:00:00.000Z"))).toBe(
        false,
      );
    });
    ...
    it("should return false for a Float16Array", () => {
      expect(IsHelper.isPlainObject(new Float16Array())).toBe(false);
    });
    ...
    it("should return false for a DataView", () => {
      expect(IsHelper.isPlainObject(new DataView(new ArrayBuffer(8)))).toBe(
        false,
      );
    });
  });
