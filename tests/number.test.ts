...
describe("isNumber", () => {
  ...
  describe("false test cases", () => {
    ...
    it("should return false for a Date object created with a string", () => {
      expect(IsHelper.isNumber(new Date("2021-01-01T00:00:00.000Z"))).toBe(
        false,
      );
    });
    ...
    it("should return false for a Float16Array", () => {
      expect(IsHelper.isNumber(new Float16Array())).toBe(false);
    });
...
describe("isPositiveNumber", () => {
  ...
  describe("false test cases", () => {
    ...
    it("should return false for a Date object created with a string", () => {
      expect(IsHelper.isPositiveNumber(new Date("2021-01-01T00:00:00.000Z")))
        .toBe(
          false,
        );
    });
    ...
    it("should return false for a Float16Array", () => {
      expect(IsHelper.isPositiveNumber(new Float16Array())).toBe(false);
    });
...
describe("isInteger", () => {
  ...
  describe("false test cases", () => {
    ...
    it("should return false for a Date object created with a string", () => {
      expect(IsHelper.isInteger(new Date("2021-01-01T00:00:00.000Z"))).toBe(
        false,
      );
    });
    ...
    it("should return false for a Float16Array", () => {
      expect(IsHelper.isInteger(new Float16Array())).toBe(false);
    });
...
describe("isPositiveInteger", () => {
  ...
  describe("false test cases", () => {
    ...
    it("should return false for a Date object created with a string", () => {
      expect(IsHelper.isPositiveInteger(new Date("2021-01-01T00:00:00.000Z")))
        .toBe(
          false,
        );
    });
    ...
    it("should return false for a Float16Array", () => {
      expect(IsHelper.isPositiveInteger(new Float16Array())).toBe(false);
    });
